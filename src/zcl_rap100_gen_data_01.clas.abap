CLASS zcl_rap100_gen_data_01 DEFINITION
PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_01 IMPLEMENTATION.
...
*   clear data
    DELETE FROM zrap100_atrav01.
    DELETE FROM zrap100_atrv01_d.

    "insert travel demo data
    INSERT zrap100_atrav01  FROM (
        SELECT
